...
.EXAMPLE
  new-warp-chat.ps1 -TabName breakout -LaunchCmd claude -LaunchArgs '--chrome --dangerously-skip-permissions' -SeedFile C:\tmp\seed.txt
.EXAMPLE
  new-warp-chat.ps1 -TabName codex-chat -LaunchCmd codex -LaunchArgs '--yolo'   # empty fresh chat, no seed
#>
[CmdletBinding()]
param(
